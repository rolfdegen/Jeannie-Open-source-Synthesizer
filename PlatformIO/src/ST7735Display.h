		...
		if (myPageShiftStatus[PageNr] == false) {
			...
			// USBCTRL
				...
				if (val != USBctrl)
				{
					USBctrl = val;
					storeUSBctrl(val);
					tft.fillRoundRect(133,40,22,10,2,ST7735_BLUE);
					tft.setTextColor(ST7735_WHITE);
...
FLASHMEM void drawSystemPar1 (void)
{
	...
	print_String(340,85,40);	// print "USBCTRL"
	print_String(141,85,59);	// print "VELCURV"
