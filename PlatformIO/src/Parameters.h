...
float mypwA = 0.0f;
float mypwB = 0.0f;
uint8_t Osc1_PWAMT_value = 0;
uint8_t Osc2_PWAMT_value = 0;
uint8_t Osc1_SPREAD_value = 0;
uint8_t Osc2_SPREAD_value = 0;
uint8_t Osc1_SAWMIX_value = 0;
uint8_t Osc2_SAWMIX_value = 0;
uint8_t Osc1_PWMOD_value = 0;
uint8_t Osc2_PWMOD_value = 0;
...
int32_t previous_parameter_[1];
int32_t parameter_[1];
int32_t par_size;
//int32_t parameter_xfade;
//int32_t parameter_0_start;
//int32_t parameter_0_delta;
//int32_t parameter_increment;
