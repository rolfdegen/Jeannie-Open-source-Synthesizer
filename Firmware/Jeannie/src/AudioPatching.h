...
AudioSynthWaveformDc     wtEnvelopeDC;
...
AudioEffectEnvelope      wtEnvelope[8];
...
AudioAmplifier			 AmpOutL;
AudioAmplifier			 AmpOutR;
...
AudioConnection wavetableEnvelope_PrmMixerA[8] = {
	{wtEnvelope[0], 0, Osc_Prm_mixer_A[0], 3},
	{wtEnvelope[1], 0, Osc_Prm_mixer_A[1], 3},
	{wtEnvelope[2], 0, Osc_Prm_mixer_A[2], 3},
	{wtEnvelope[3], 0, Osc_Prm_mixer_A[3], 3},
	{wtEnvelope[4], 0, Osc_Prm_mixer_A[4], 3},
	{wtEnvelope[5], 0, Osc_Prm_mixer_A[5], 3},
	{wtEnvelope[6], 0, Osc_Prm_mixer_A[6], 3},
	{wtEnvelope[7], 0, Osc_Prm_mixer_A[7], 3},
};
AudioConnection wavetableEnvelope_PrmMixerB[8] = {
	{wtEnvelope[0], 0, Osc_Prm_mixer_B[0], 3},
	{wtEnvelope[1], 0, Osc_Prm_mixer_B[1], 3},
	{wtEnvelope[2], 0, Osc_Prm_mixer_B[2], 3},
	{wtEnvelope[3], 0, Osc_Prm_mixer_B[3], 3},
	{wtEnvelope[4], 0, Osc_Prm_mixer_B[4], 3},
	{wtEnvelope[5], 0, Osc_Prm_mixer_B[5], 3},
	{wtEnvelope[6], 0, Osc_Prm_mixer_B[6], 3},
	{wtEnvelope[7], 0, Osc_Prm_mixer_B[7], 3},
};
AudioConnection wavetableEnvelope_PrmMixerC[8] = {
	{wtEnvelope[0], 0, Osc_Prm_mixer_C[0], 3},
	{wtEnvelope[1], 0, Osc_Prm_mixer_C[1], 3},
	{wtEnvelope[2], 0, Osc_Prm_mixer_C[2], 3},
	{wtEnvelope[3], 0, Osc_Prm_mixer_C[3], 3},
	{wtEnvelope[4], 0, Osc_Prm_mixer_C[4], 3},
	{wtEnvelope[5], 0, Osc_Prm_mixer_C[5], 3},
	{wtEnvelope[6], 0, Osc_Prm_mixer_C[6], 3},
	{wtEnvelope[7], 0, Osc_Prm_mixer_C[7], 3},
};
AudioConnection wavetableEnvelope_PrmMixerD[8] = {
	{wtEnvelope[0], 0, Osc_Prm_mixer_D[0], 3},
	{wtEnvelope[1], 0, Osc_Prm_mixer_D[1], 3},
	{wtEnvelope[2], 0, Osc_Prm_mixer_D[2], 3},
	{wtEnvelope[3], 0, Osc_Prm_mixer_D[3], 3},
	{wtEnvelope[4], 0, Osc_Prm_mixer_D[4], 3},
	{wtEnvelope[5], 0, Osc_Prm_mixer_D[5], 3},
	{wtEnvelope[6], 0, Osc_Prm_mixer_D[6], 3},
	{wtEnvelope[7], 0, Osc_Prm_mixer_D[7], 3},
};
...
AudioConnection wtEnvelope_connections[8] = {
	{wtEnvelopeDC, wtEnvelope[0]},
	{wtEnvelopeDC, wtEnvelope[1]},
	{wtEnvelopeDC, wtEnvelope[2]},
	{wtEnvelopeDC, wtEnvelope[3]},
	{wtEnvelopeDC, wtEnvelope[4]},
	{wtEnvelopeDC, wtEnvelope[5]},
	{wtEnvelopeDC, wtEnvelope[6]},
	{wtEnvelopeDC, wtEnvelope[7]}
};
...
AudioConnection hp_filter_on[8] = {
	{multiply1, 0, hpFilter1, 0},
	{multiply2, 0, hpFilter2, 0},
	{hpFilter1, 2, AmpOutL, 0},
	{hpFilter2, 2, AmpOutR, 0},
	{AmpOutL, 0, PCM5102A, 0},
	{AmpOutR, 0, PCM5102A, 1},
	{AmpOutL, 0, ScopePeakMixer, 0},
	{AmpOutR, 0, ScopePeakMixer, 1},
};

AudioConnection hp_filter_off[6] = {
	{multiply1, 0, AmpOutL, 0},
	{multiply2, 0, AmpOutR, 0},
	{AmpOutL, 0, PCM5102A, 0},
	{AmpOutR, 0, PCM5102A, 1},
	{AmpOutL, 0, ScopePeakMixer, 0},
	{AmpOutR, 0, ScopePeakMixer, 1},
