...
// Patch Dump is 449 Byte
// Bank Dump is 57472 Byte
// NO_OF_SysEx_Data: 265
//*************************************************************************
FLASHMEM void get_SysEx_Dump(void) {
	...
	//filterFreq = readDoubleSysex(count);	count+=2;						// (23) filterFreq (18 - 22000)
	filterFreq = sysex5Byte_to_string(Syx_Buf, count, 5).toFloat();			
	...
	envelopeType1 = 0; // clear parameter for Env3 
	...
	Lfo3Retrig = Syx_Buf[count++];											// (264) Lfo3Retrig (0...2) PHA
	MasterVolume = sysex5Byte_to_string(Syx_Buf, count, 4).toFloat();		// (265) MasterVolume (float)
	ModWheelPRM_Aamt = Syx_Buf[count++];									// (266) ModWheelPRM_Aamt (0...127)
	ModWheelPRM_Bamt = Syx_Buf[count++];									// (267) ModWheelPRM_Bamt (0...127)
	ModWheelPRM_Aamt2 = Syx_Buf[count++];									// (268) ModWheelPRM_Aamt2 (0...127)
	ModWheelPRM_Bamt2 = Syx_Buf[count++];									// (269) ModWheelPRM_Bamt2 (0...127)
	AtouchPRM_Aamt = Syx_Buf[count++];										// (270) AtouchPRM_Aamt (0...127)
	AtouchPRM_Bamt = Syx_Buf[count++];										// (271) AtouchPRM_Bamt (0...127)
	AtouchPRM_Aamt2 = Syx_Buf[count++];										// (272) AtouchPRM_Aamt2 (0...127)
	AtouchPRM_Bamt2 = Syx_Buf[count++];										// (273) AtouchPRM_Bamt2 (0...127)
	user_wavetable_index[0] = Syx_Buf[count++];								// (274) user_wavetable_index[0] (0...127)
	user_wavetable_index[1] = Syx_Buf[count++];								// (275) user_wavetable_index[1] (0...127)
	KEY_mod_LOUDNESS = Syx_Buf[count++];									// (276) KEY_mod_LOUDNESS (0...127)
	Env3Osc1PrmAAmt = Syx_Buf[count++];										// (277) Env3Osc1PrmAAmt (0...127)
	Env3Osc1PrmBAmt = Syx_Buf[count++];										// (278) Env3Osc1PrmBAmt (0...127)
	Env3Osc2PrmAAmt = Syx_Buf[count++];										// (279) Env3Osc2PrmAAmt (0...127)
	Env3Osc2PrmBAmt = Syx_Buf[count++];										// (280) Env3Osc2PrmBAmt (0...127)
	wtAttack = readDoubleSysex(count);	count+=2;							// (281) wtAttack (0 - 11880)
	wtDecay = readDoubleSysex(count);	count+=2;							// (282) wtDecay (0 - 11880)
	wtSustain = sysex1Byte_to_string(Syx_Buf, count, 2).toFloat();			// (283) wtSustain (0 - 1.00)
	wtRelease = readDoubleSysex(count);	count+=2;							// (284) wtRelease (0 - 11880)
	Osc_drift_value = Syx_Buf[count++];										// (285) Osc_drift_value (0...127)
