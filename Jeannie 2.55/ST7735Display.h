...
FLASHMEM void printModParameter(uint8_t ParameterNo)
{
	...
	if (ParameterNo < 4) {
		...
		print_String(186,27,(39 + (2 * 19)));	// print "OSC1"
		print_String(187,27,(39 + (3 * 19)));	// print "OSC2"
		...
		print_String(215,29,(39 + (0 * 19)));	// print "LFO3"
		print_String(215,29,(39 + (1 * 19)));	// print "LFO3"
		print_String(215,29,(39 + (2 * 19)));	// print "LFO3"
		print_String(215,29,(39 + (3 * 19)));	// print "LFO3"
		
		print_String(53,119,(39 + (0 * 19)));	// print "VCA"
		print_String(205,117,(39 + (1 * 19)));	// print "FxP1"
		print_String(206,117,(39 + (2 * 19)));	// print "FxP2"
		print_String(207,117,(39 + (3 * 19)));	// print "FxP3"
		
	}
	else if (ParameterNr < 16) {
		print_String(164,29,(39 + (0 * 19)));	// print " "
		print_String(215,29,(39 + (1 * 19)));	// print "LFO3"
		print_String(212,24,(39 + (2 * 19)));	// print "Atouch"
		print_String(212,24,(39 + (3 * 19)));	// print "Atouch"
		
		print_String(164,114,(39 + (0 * 19)));	// print " "
		print_String(210,114,(39 + (1 * 19)));	// print "FxMIX"
		print_String(182,111,(39 + (2 * 19)));	// print "Cutoff"
		print_String(181,114,(39 + (3 * 19)));	// print "Pitch"
		...
		print_String(205,117,(39 + (2 * 19)));	// print "FxP1"
		print_String(206,117,(39 + (3 * 19)));	// print "FxP2"
		...
		print_String(212,24,(39 + (2 * 19)));	// print "Atouch"
		print_String(164,21,(39 + (3 * 19)));	// print "---"
		
		print_String(207,117,(39 + (0 * 19)));	// print "FxP3"
		print_String(164,114,(39 + (1 * 19)));	// print " "
		print_String(210,114,(39 + (2 * 19)));	// print "FxMIX"
		print_String(164,117,(39 + (3 * 19)));	// print " "
...
FLASHMEM void renderModParameter(uint8_t ParameterNr, uint8_t value)
{
	...
	else if (ParameterNr == 12) {	// LFO3 > FxCLKamt
		FxCLKamt = value;
	}
	...
	else if (ParameterNr == 21) {	// Atouch > FxClk Amt
		AtouchFxClkAmt = value;
	}
...
FLASHMEM void drawMainPage (void) {
	...
	if (MainShift == true && PickUpflag == true) {
		...
		// LF3 (LFO3 AMT)
		LF3_val = float(Lfo3amt * 127.0f);
		
		//  L1R-L3R (LFO1-3 rate)
		L1R_val = myLFO1RateValue;
		L2R_val = myLFO2RateValue;
		L3R_val = myLFO3RateValue;
		
		// load Pick up values for User Pots
		clr_pickup();
		int potVal1 = MCP_adc.read(MCP3208::Channel::SINGLE_0);
		int potVal2 = MCP_adc.read(MCP3208::Channel::SINGLE_1);
		int potVal3 = MCP_adc.read(MCP3208::Channel::SINGLE_2);
		int potVal4 = MCP_adc.read(MCP3208::Channel::SINGLE_3);

		for (uint8_t i = 0; i < 5; i++) {
			potVal1 = MCP_adc.read(MCP3208::Channel::SINGLE_0);
			Serial.println(potVal1 >> 5);
		}
		...
		if (UserPot[0] == 0) {
			...
			PrevValue[0] = CUT_val >> 1;
			printPickupValue (0, CUT_val >> 1, potVal1 >> 5, 0);
		}
		else if (UserPot[0] == 2) {
			PrevValue[0] = RES_val;
			printPickupValue (0, RES_val, potVal1 >> 5, 0);
		}
		else if (UserPot[0] == 3) {
			PrevValue[0] = LF1_val;
			printPickupValue (0, LF1_val, potVal1 >> 5, 0);
			//Serial.println("Pickup");
			//Serial.println(LF1_val);
			//Serial.println(potVal1 >> 5);
		}
		else if (UserPot[0] == 4) {
			PrevValue[0] = LF2_val;
			printPickupValue (0, LF2_val, potVal1 >> 5, 0);
		}
		else if (UserPot[0] == 5) {
			PrevValue[0] = LF3_val;
			printPickupValue (0, LF3_val, potVal1 >> 5, 0);
		}
		else if (UserPot[0] == 6) {
			PrevValue[0] = L1R_val;
			printPickupValue (0, L1R_val, potVal1 >> 5, 0);
		}
		else if (UserPot[0] == 7) {
			PrevValue[0] = L2R_val;
			printPickupValue (0, L2R_val, potVal1 >> 5, 0);
		}
		else if (UserPot[0] == 8) {
			PrevValue[0] = L3R_val;
			printPickupValue (0, L3R_val, potVal1 >> 5, 0);
		}
		...
		if (UserPot[1] == 0) {
			...
			PrevValue[1] = CUT_val >> 1;
			printPickupValue (1, CUT_val >> 1, potVal2 >> 5, 0);
		}
		else if (UserPot[1] == 2) {
			PrevValue[1] = RES_val;
			printPickupValue (1, RES_val, potVal2 >> 5, 0);
		}
		else if (UserPot[1] == 3) {
			PrevValue[1] = LF1_val;
			printPickupValue (1, LF1_val, potVal2 >> 5, 0);
		}
		else if (UserPot[1] == 4) {
			PrevValue[1] = LF2_val;
			printPickupValue (1, LF2_val, potVal2 >> 5, 0);
		}
		else if (UserPot[1] == 5) {
			PrevValue[1] = LF3_val;
			printPickupValue (1, LF3_val, potVal2 >> 5, 0);
		}
		else if (UserPot[1] == 6) {
			PrevValue[1] = L1R_val;
			printPickupValue (1, L1R_val, potVal2 >> 5, 0);
		}
		else if (UserPot[1] == 7) {
			PrevValue[1] = L2R_val;
			printPickupValue (1, L2R_val, potVal2 >> 5, 0);
		}
		else if (UserPot[1] == 8) {
			PrevValue[1] = L3R_val;
			printPickupValue (1, L3R_val, potVal2 >> 5, 0);
		}
		...
		if (UserPot[2] == 0) {
			...
			PrevValue[2] = CUT_val >> 1;
			printPickupValue (2, CUT_val >> 1, potVal3 >> 5, 0);
		}
		else if (UserPot[2] == 2) {
			PrevValue[2] = RES_val;
			printPickupValue (2, RES_val, potVal3 >> 5, 0);
		}
		else if (UserPot[2] == 3) {
			PrevValue[2] = LF1_val;
			printPickupValue (2, LF1_val, potVal3 >> 5, 0);
		}
		else if (UserPot[2] == 4) {
			PrevValue[2] = LF2_val;
			printPickupValue (2, LF2_val, potVal3 >> 5, 0);
		}
		else if (UserPot[2] == 5) {
			PrevValue[2] = LF3_val;
			printPickupValue (2, LF3_val, potVal3 >> 5, 0);
		}
		else if (UserPot[2] == 6) {
			PrevValue[2] = L1R_val;
			printPickupValue (2, L1R_val, potVal3 >> 5, 0);
		}
		else if (UserPot[2] == 7) {
			PrevValue[2] = L2R_val;
			printPickupValue (2, L2R_val, potVal3 >> 5, 0);
		}
		else if (UserPot[2] == 8) {
			PrevValue[2] = L3R_val;
			printPickupValue (2, L3R_val, potVal3 >> 5, 0);
		}
		...
		if (UserPot[3] == 0) {
			...
			PrevValue[3] = CUT_val >> 1;
			printPickupValue (3, CUT_val >> 1, potVal4 >> 5, 0);
		}
		else if (UserPot[3] == 2) {
			PrevValue[3] = RES_val;
			printPickupValue (3, RES_val, potVal4 >> 5, 0);
		}
		else if (UserPot[3] == 3) {
			PrevValue[3] = LF1_val;
			printPickupValue (3, LF1_val, potVal4 >> 5, 0);
		}
		else if (UserPot[3] == 4) {
			PrevValue[3] = LF2_val;
			printPickupValue (3, LF2_val, potVal4 >> 5, 0);
		}
		else if (UserPot[3] == 5) {
			PrevValue[3] = LF3_val;
			printPickupValue (3, LF3_val, potVal4 >> 5, 0);
		}
		else if (UserPot[3] == 6) {
			PrevValue[3] = L1R_val;
			printPickupValue (3, L1R_val, potVal4 >> 5, 0);
		}
		else if (UserPot[3] == 7) {
			PrevValue[3] = L2R_val;
			printPickupValue (3, L2R_val, potVal4 >> 5, 0);
		}
		else if (UserPot[3] == 8) {
			PrevValue[3] = L3R_val;
			printPickupValue (3, L3R_val, potVal4 >> 5, 0);
		}
...
{		
	...
	// cal HPF filter frequeny
	Frq = float(HPF_filterFreq);
	for (int i = 0; i < 256; i++) {
	...
	// SUB Page enabled (HP-Filter)
		...
		// print parameter values
		printDataValue (0, HPF_value >> 1);
		printRedMarker (0, HPF_value >> 1);
...
FLASHMEM void draw_Ladder_Filter_page (void)
{
	...
	if (myPageShiftStatus[PageNr] == 2) {
		//draw_HPF_filter_curves(HPF_value >> 1, HPF_Res_value);
		draw_HPF_filter_curves(HPF_value >> 1, HPFRes_value);
		} else {
		draw_filter_curves(Frq_value >> 1, FilterReso, Filter_mix);
	}
	...
	// SUB Page enabled
		...
		PrevValue[0] = HPF_value >> 1;
		if (pickupFlag == true) {
			printPickupValue (0, HPF_value >> 1, potVal1 >> 5, 0);
			} else {
			printPickupValue (0, HPF_value >> 1, HPF_value >> 1, 0);
		}
		
		PrevValue[1] = HPF_Res_value;
		if (pickupFlag == true) {
			printPickupValue (1, HPF_Res_value, potVal2 >> 5, 0);
			} else {
			printPickupValue (1, HPF_Res_value, HPF_Res_value, 0);
		}
...
FLASHMEM void drawSystemPar2 (void)
{
	...
	tft.setTextColor(ST7735_GRAY);
	print_String(222,85,21);		// print "POT1"
	print_String(223,85,40);		// print "POT2"
	print_String(224,85,59);		// print "POT3"
	print_String(225,85,78);		// print "POT4"
