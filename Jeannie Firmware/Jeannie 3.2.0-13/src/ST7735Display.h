...
FLASHMEM void printModParameter(uint8_t ParameterNo)
{
	...
	if (ParameterNo < 4) {
		...
		print_String(345,24,(39 + (0 * 19)));	// print "KEY"
		print_String(347,24,(39 + (1 * 19)));	// print "VELO"
		print_String(164,24,(39 + (2 * 19)));	// print " "
		print_String(164,24,(39 + (3 * 19)));	// print " "
		print_String(348,103,(39 + (0 * 19)));	// print "WAVES"
		print_String(348,103,(39 + (1 * 19)));	// print "WAVES"
...
FLASHMEM void renderModParameter(uint8_t ParameterNr, uint8_t value)
{
	...
	else if (ParameterNr == 44) {	// KEY > WAVES
		KEY_mod_WAVES = value;
	}
	else if (ParameterNr == 45) {	// VELO > WAVES
		VELO_mod_WAVES = value;
	}
}
