...
// Patch Dump is 444 Byte
// Bank Dump is 56832 Byte
...
FLASHMEM void get_SysEx_Dump(void) {
	...
	MasterVolume = sysex5Byte_to_string(Syx_Buf, count, 4).toFloat();		// (269) MasterVolume (float)
	ModWheelPRM_Aamt = Syx_Buf[count++];									// (270) ModWheelPRM_Aamt (0...127)
	ModWheelPRM_Bamt = Syx_Buf[count++];									// (270) ModWheelPRM_Bamt (0...127)
	ModWheelPRM_Aamt2 = Syx_Buf[count++];									// (270) ModWheelPRM_Aamt2 (0...127)
	ModWheelPRM_Bamt2 = Syx_Buf[count++];									// (270) ModWheelPRM_Bamt2 (0...127)
	AtouchPRM_Aamt = Syx_Buf[count++];										// (270) AtouchPRM_Aamt (0...127)
	AtouchPRM_Bamt = Syx_Buf[count++];										// (270) AtouchPRM_Bamt (0...127)
	AtouchPRM_Aamt2 = Syx_Buf[count++];										// (270) AtouchPRM_Aamt2 (0...127)
	AtouchPRM_Bamt2 = Syx_Buf[count++];										// (270) AtouchPRM_Bamt2 (0...127)
	user_wavetable_index[0] = Syx_Buf[count++];								// (270) user_wavetable_index[0] (0...127)
	user_wavetable_index[1] = Syx_Buf[count++];								// (270) user_wavetable_index[1] (0...127)
}